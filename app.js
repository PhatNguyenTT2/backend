...
// const inventoryMovementsRouter = require('./controllers/inventoryMovements')
...
// app.use('/api/detail-customers', detailCustomersRouter)
// app.use('/api/detail-products', detailProductsRouter)
...
// app.use('/api/detail-suppliers', detailSuppliersRouter)
