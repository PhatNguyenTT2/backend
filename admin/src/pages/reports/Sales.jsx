...
const SalesReports = () => {
  ...
  const fetchSalesReport = async () => {
    ...
    try {
      ...
      setError(err.error || err.message || 'Failed to load sales report');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="text-[13px] text-gray-600 font-['Poppins',sans-serif] mt-1">
            View product sales by date range
          </p>
        </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-[13px] font-['Poppins',sans-serif] font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
                >
                  {loading ? (
                    <>
        ...
        {summary && (
          <div className="grid grid-cols-4 gap-4">
            <div className="bg-white rounded-lg shadow-sm p-4 border-l-4 border-blue-500">
              <p className="text-[11px] text-gray-600 font-['Poppins',sans-serif] font-medium uppercase tracking-[0.5px]">Total Revenue</p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 border-l-4 border-purple-500">
              <p className="text-[11px] text-gray-600 font-['Poppins',sans-serif] font-medium uppercase tracking-[0.5px]">Total Orders</p>
              <p className="text-[20px] font-bold font-['Poppins',sans-serif] text-purple-600 mt-1">
                {summary.totalOrders || 0}
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-sm p-4 border-l-4 border-orange-500">
              <p className="text-[11px] text-gray-600 font-['Poppins',sans-serif] font-medium uppercase tracking-[0.5px]">Products Sold</p>
