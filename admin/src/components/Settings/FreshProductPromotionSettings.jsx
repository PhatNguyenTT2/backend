      ...
      <div className="space-y-6">
        ...
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex gap-2">
            ...
            <div className="flex-1">
              <h4 className="text-[13px] font-semibold text-blue-900 mb-1">How Auto-Promotion Works</h4>
              <ul className="text-[12px] text-blue-800 space-y-1 list-disc list-inside">
                <li>System checks fresh products (category='fresh') every day at configured time</li>
                <li>Batches matching expiry criteria will automatically get discount applied</li>
                <li>Promotion type will be set to 'discount' with configured percentage</li>
                <li>Manual promotions can override auto-promotions anytime</li>
                <li>Expired batches will have promotion removed automatically</li>
              </ul>
            </div>
          </div>
        </div>
