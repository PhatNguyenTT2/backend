  ...
  if (loading) {
    return (
      <div className="bg-white rounded-xl shadow-sm py-12 text-center">
        ...
        <p className="mt-4 text-sm text-gray-500">Loading employee data...</p>
      </div>
    );
  }
  ...
  if (!employees || employees.length === 0) {
    return (
      <div className="bg-white rounded-xl shadow-sm py-16 text-center">
        ...
        <h3 className="mt-4 text-base font-semibold text-gray-900">No employee data found</h3>
        <p className="mt-2 text-sm text-gray-500">
          There are no employee sales in the selected period
        </p>
      </div>
    );
  }
